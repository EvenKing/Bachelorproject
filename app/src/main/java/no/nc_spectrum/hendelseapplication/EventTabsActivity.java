...
public class EventTabsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "Logged in as: " + name + "\nwith password (encrypted): " + password , Toast.LENGTH_LONG).show();
        ...
        /*  //TODO : Må fikse overføring av data mellom aktiviteter!!!
            String phoneNumber = intent.getExtras().getString("phoneNumber");
            //TOAST!!
            Toast.makeText(this, "Logget inn med: " + phoneNumber + " !", Toast.LENGTH_SHORT).show();
        */
